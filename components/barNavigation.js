      ...
      {({ open }) => (
        <>
          <div className="md:flex md:justify-center px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-24">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "text-gray-100  hover:text-white active:bg-prima duration-100  hover:border-b  hover:border-b-prima hover:scale-105",
                ...
                <Menu
                  as="div"
                  className="pt-3 pl-20 relative hidden sm:block z-10"
                >
                  <div>
                    <Menu.Button className="text-gray-300 hover:bg-gray-700 hover:text-white hover:scale-105 px-3 py-2 text-sm font-mono font-medium border border-b-prima border-t-0 border-x-0 rounded-full">
                  ...
                  >
                    <Menu.Items className="origin-top-right absolute left-0 mt-2 w-44 rounded-md shadow-lg py-1 bg-brandBlue ring-1 ring-black ring-opacity-5 focus:outline-none">
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="px-2 pt-2 pb-36 space-y-8">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
                  ...
                  className={classNames(
                    item.current
                      ? "bg-gray-900 text-white"
                      : "text-gray-300 hover:bg-gray-700 hover:text-white font-mono ",
                    "block px-3 py-2 rounded-md text-lg  font-medium w-fit"
                  )}
                  aria-current={item.current ? "page" : undefined}
                >
                  {item.name}
