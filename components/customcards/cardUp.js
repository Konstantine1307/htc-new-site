...
function CardUp(props) {
  ...
  return (
    <>
      <div className="relative py-6 mt-6 md:mt-0 w-3/4 md:w-4/12 mx-auto  md:px-4 text-center hover:scale-105 duration-300 shadow-xl shadow-brandBlue rounded-2xl">
        <div className="bg-cover rounded-2xl" style={backImgBackGround}>
          {/* Overlay */}
          <Overlay />
          <div className="relative rounded-lg bg-gradient-to-t hover:from-pink-500 hover:to-cyan-500 duration-150">
